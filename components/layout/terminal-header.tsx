      ...
      {spotPrice !== null && (
        <div className="flex items-center gap-2.5">
          ...
          <div className="bg-[#121215] border border-[#222] rounded px-3 py-1 flex items-baseline gap-1.5 h-8">
            <span className="text-[9px] text-[#949494] font-mono uppercase font-bold tracking-wider">LAST PRICE</span>
          ...
          <div className={`border rounded px-3 py-1 flex items-baseline gap-1.5 h-8 transition-colors ${
            ...
            <span className="text-[9px] text-[#949494] font-mono uppercase font-bold tracking-wider">CHANGE</span>
            <span className={`text-xs font-bold font-mono ${isUp ? 'text-[#00C805]' : 'text-[#FF3B60]'}`}>
